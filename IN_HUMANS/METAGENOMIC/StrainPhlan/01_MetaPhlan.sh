...
## Variables
mpa_indir=/scratch/<USERS>/<Project_scratch>/Host_extracted_reads
mpa_sams=/scratch/<USERS>/<Project_scratch>/MetaPhlan_output/sams
mpa_profiles=/scratch/<USERS>/<Project_scratch>/MetaPhlan_output/profiles
mpa_bowtie=/scratch/<USERS>/<Project_scratch>/MetaPhlan_output/bowtie2
