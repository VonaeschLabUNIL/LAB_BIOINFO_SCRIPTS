...
#SBATCH --array 1-XXX #check this line to know how many clades in clade.txt : Thu Dec 19 15:05:41 2024: Detected 2 clades: 
...
## Variables
indir=/scratch/<USERS>/<Project_scratch>Consensus_markers
outdir_clade=/scratch/<USERS>/<Project_scratch>/CladeMarkers
outdir_sp=/scratch/<USERS>/<Project_scratch>/StrainPhlan_output
